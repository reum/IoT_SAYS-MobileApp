...
public class Section_12_W : PoolableObject
{
    ...
    void CheckPPM()
    {
        if (ras_1_ppm >= 99)
        {
            render.color = new Color32(220, 10, 10, 255);
        }
        else if (ras_1_ppm < 99 && ras_1_ppm >= 49)
        {
            render.color = new Color32(200, 220, 10, 255);

        }
        else
        {
            render.color = new Color32(90, 220, 40, 255);
        }
